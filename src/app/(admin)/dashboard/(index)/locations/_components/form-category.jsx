...
import {postCategory} from "@/app/(admin)/dashboard/(index)/locations/libs/actions";
import {editCategoryById} from "@/app/(admin)/dashboard/(index)/locations/libs/actions";
        ...
        <div className="flex justify-center h-screen items-center">
            <form action={formAction}>
                ...
                <Card className="w-[350px]">
                    <CardHeader>
                        <CardTitle>Location Controller</CardTitle>
