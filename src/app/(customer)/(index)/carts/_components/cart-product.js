                ...
                <div key={product.id}
                    ...
                    <div className="w-[120px] flex flex-col gap-1">
                        ...
                        <div className="flex items-center gap-3">
                            <button type="button" onClick={() => decreaseQuantity(product.id)} className="w-6 h-6 flex shrink-0">
                                <img src="assets/icons/minus-cirlce.svg" alt="minus"/>
                            </button>
                            <p className="text-[#0D5CD7] font-semibold leading-[22px]">{product.quantity}</p>
                            <button type="button" onClick={() => increaseQuantity(product.id)} className="w-6 h-6 flex shrink-0">
