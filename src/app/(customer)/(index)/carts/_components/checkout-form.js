...
const CheckOutButton = () => {
    ...
    return (
        <button disabled={pending} type="submit"
                className="p-[12px_24px] bg-[#0D5CD7] rounded-full text-center font-semibold text-white">{pending ? "Loading..." : "Checkout Now"}</button>
    )
}
        ...
        <form action={formAction} id="checkout-info"
            ...
            <div className="w-[650px] flex flex-col shrink-0 gap-4 h-fit">
                ...
                <div className="flex flex-col gap-5 p-[30px] rounded-3xl border border-[#E5E5E5] bg-white">
                    ...
                    <div
                        className="flex items-start gap-[10px] rounded-[20px] border border-[#E5E5E5] p-[12px_20px] focus-within:ring-2 focus-within:ring-[#FFC736] transition-all duration-300">
                        <div className="flex shrink-0">
